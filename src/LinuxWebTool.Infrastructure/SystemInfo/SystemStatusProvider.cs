...
public sealed partial class SystemStatusProvider : ISystemStatusProvider
{
    ...
    private readonly IDiskStatusCache _diskStatusCache;
    ...
    public SystemStatusProvider(SystemStatusOptions options, IDiskStatusCache diskStatusCache)
    {
        _options = options;
        _diskStatusCache = diskStatusCache;
    }
    ...
    private SystemStatusResult Collect()
    {
        lock (_sync)
        {
            ...
            return new SystemStatusResult
            {
                ...
                Cpu = cpu,
                Memory = memory,
                Disks = _diskStatusCache.GetSnapshot(),
